...
#==================================输入输出路径,输出名称=================================
path_input="DATA/SDERE_input/SDERE_event_pair_sample.csv"
path_output="DATA/SDERE_output"
output_name=f"SDERE_2.0_test_{MODEL}"
timestamp = datetime.now().strftime("%Y%m%d_%H%M")
output_filename = os.path.join(path_output, f"{output_name}_{timestamp}.jsonl")

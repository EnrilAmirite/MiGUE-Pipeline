...
from PIPE_3_ERE_CROSS_DOC.CDERE_function_design_concurrency import maintain_clean_global,maintain_must_and_must_not,maintain_have_answer
from PIPE_3_ERE_CROSS_DOC.CDERE_function_design_concurrency import CDERE_prompt_intro,option_to_relation_name,option_to_specific_name
from PIPE_3_ERE_CROSS_DOC.CDERE_function_design_concurrency import create_specific_question,create_relation_question,after_thinking
from PIPE_3_ERE_CROSS_DOC.CDERE_function_design_concurrency import init_state
import re
...
#==================================输入输出路径,输出名称=================================
path_input=f"DATA/CDERE_input/CDERE_event_pair_{suffix}.csv"
output_folder="DATA/CDERE_output"
output_name=f"CDERE_3_{suffix}"

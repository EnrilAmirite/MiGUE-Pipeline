from src.event_relation_anno.load_erai_data import load_erai_data,record_status
...
class erai(load_erai_data):
    ...
    def erai_cc(self):
        ...
        with ThreadPoolExecutor(max_workers=self.max_workers) as executor:
            ...
            with tqdm(
                total=tt_task,
                desc="Doing event relation annotation........."
            ) as pbar:
                for future in as_completed(futures):
                    ...
                    pbar.update(1)  
        print("Finished event relation annotation!\n")      
